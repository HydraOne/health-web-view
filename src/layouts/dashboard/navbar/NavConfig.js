...
const elderlyNavConfig = [
  {
    subheader: 'general',
    items: [
      { title: '今日安排', path: PATH_DASHBOARD.general.booking, icon: ICONS.booking },
    ],
  }
]
...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    subheader: 'app',
    items: [
      { title: '用户管理', path: PATH_DASHBOARD.user.accountList, icon: ICONS.chat },
      { title: '健康新闻', path: PATH_DASHBOARD.eCommerce.healthNews, icon: ICONS.chat },
      { title: '体检项目管理', path: PATH_DASHBOARD.eCommerce.list, icon: ICONS.chat },
